// =============================================================================
//
// [ PROJ ] Stata unit testing example
// [ FILE ] test-term_code_to_yyyy_bug.do (in util_commands.do)
...
// (1) Confirm that year is correctly created
test_command term_code_to_yyyy_bug, termcodevar(term_code) generate(year)
...
test_command term_code_to_yyyy_bug if group == 1, termcodevar(term_code) generate(year2)
...
test_command term_code_to_yyyy_bug in 1/3, termcodevar(term_code) generate(year3)
